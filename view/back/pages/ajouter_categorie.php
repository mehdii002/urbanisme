...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <form action="" method="POST" class="categorie-form" id="categorieForm">

  <div class="form-title">Ajouter une nouvelle catégorie</div>
  ...
  <button type="submit" name="ajouterCategorie" class="btn btn-success">Ajouter</button>
</form>
